...
@NgModule({
    imports: [RouterModule.forChild([
        { path: 'button', data: { breadcrumb: 'Button' }, loadChildren: () => import('./sindico/buttondemo.module').then(m => m.ButtonDemoModule) },
        { path: 'charts', data: { breadcrumb: 'Charts' }, loadChildren: () => import('./charts/chartsdemo.module').then(m => m.ChartsDemoModule) },
        { path: 'file', data: { breadcrumb: 'File' }, loadChildren: () => import('./moradores/filedemo.module').then(m => m.FileDemoModule) },
        ...
        { path: 'table', data: { breadcrumb: 'Table' }, loadChildren: () => import('./porteiros/tabledemo.module').then(m => m.TableDemoModule) },
