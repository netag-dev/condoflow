...
class Usuario(db.Model):
    ...
    senha_usuario = db.Column(db.String(250), nullable=False)
...
class Morador(db.Model):
    ...
    pessoa_id = db.Column(db.Integer, db.ForeignKey("pessoa.id_pessoa"))
...
class Unidade(db.Model):
    ...
    tipo_unidade_id = db.Column(db.Integer, db.ForeignKey("tipounidade.id_tipo_unidade"))
